...
- Older research topics (Ranked by my interest):
   ...
   * 7)BCI.
   * 8)Power Electronics & Batteries.
   * 9)MEMS & Circuits around MEMS.
   * 10)Place&Route Optimisation.
   * 11)Formal Verification.
   * 12)Accelerated Image Processing Algorithm with GPUs.
   * 13)Image Processing & Signal Processing.
   * 14)Robotics.
   * 15)Graphs & Geometry.
